"""
Wasserstein GAN paper implementation (https://arxiv.org/abs/1701.07875)
[Model is kept mostly same as that of dc-gan, with no sigmoid on discriminator/critic output layer]

To recap:
1. Kullback-Leibler (KL) divergence
2. Jensen-Shannon (JS) divergence
3. Wasserstein Distance     (used here)
Some materials:
